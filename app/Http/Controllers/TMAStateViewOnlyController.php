...
class TMAStateViewOnlyController extends Controller
{
    ...
    public function isSgnatureValid($message,$signature)
    {
        ...
        $certtext = file_get_contents(env('CRYPTO_WEB_CERT', dirname(__FILE__).DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'storage'.DIRECTORY_SEPARATOR.'private'.DIRECTORY_SEPARATOR.'cert.pem'));
