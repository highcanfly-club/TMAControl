<x-guest-layout> 
    <x-slot name="header">
        ...
        <div class="py-12 flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
          <div class="w-full sm:max-w-2xl mt-6 px-6 py-4 text-gray-900 dark:text-white bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
            ...
            <div x-data="{ open: false }">
                <button @click="open = true" class="inline-flex items-center border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white dark:bg-gray-800 hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">{{__('signing the message')}} (rsa/sha256)
                    <svg class="ml-2 -mr-0.5 h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
                    </svg>
                </button>
